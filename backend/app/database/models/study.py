...
class Roadmap(Base):
    ...
    roadmap_type: Mapped[str | None] = mapped_column(
        String(50),
        nullable=True,
    )
    ...
    target_exam_date: Mapped[date | None] = mapped_column(
        Date,
        nullable=True,
    )

    total_duration_days: Mapped[int | None] = mapped_column(
        Integer,
        nullable=True,
    )

    total_stages: Mapped[int | None] = mapped_column(
        Integer,
        nullable=True,
    )
...
class RoadmapStage(Base):
    ...
    ai_focus_area: Mapped[str | None] = mapped_column(
        String(100),
        nullable=True,
    )

    target_hours: Mapped[int | None] = mapped_column(
        Integer,
        nullable=True,
    )
